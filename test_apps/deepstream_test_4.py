...
if __name__ == "__main__": 
    ...
    parser.add_argument(
        ...
        metavar="FILE", 
        default="test_apps/configs/msgbroker/cfg_redis.txt"
        )
    parser.add_argument(
        "--pgie-cfg", 
        dest="pgie_cfg", 
        metavar="FILE", 
        default="test_apps/configs/pgies/dstest4_pgie_config.txt"
        )
    parser.add_argument(
        "--msconv-cfg", 
        dest="msconv_cfg", 
        metavar="FILE",
        default="test_apps/configs/dstest4_msgconv_config.txt"
        )
    parser.add_argument(
        "--input-file", 
        dest="input_file", 
