...
if __name__ == "__main__": 
    ...
    parser.add_argument(
        "--pgie-config-path",
        type=str,
        default="test_apps/configs/pgies/dstest2_pgie_config.txt",
        help="Path to the pgie config file",
    )
    parser.add_argument(
        "--sgie-config-path1",
        type=str,
        default="test_apps/configs/sgies/dstest2_sgie1_config.txt",
        help="Path to the sgie1 config file",
    )
    parser.add_argument(
        "--sgie-config-path2",
        type=str,
        default="test_apps/configs/sgies/dstest2_sgie2_config.txt",
        help="Path to the sgie2 config file",
    )
    parser.add_argument(
        "--tracker-config-path",
        type=str,
        default="test_apps/test_apps/configs/tracker/dstest2_tracker_config.txt",
